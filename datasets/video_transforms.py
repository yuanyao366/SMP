#### Modified from: https://github.com/TengdaHan/MemDPC/blob/master/utils/augmentation.py
import random
import numbers
import math
import collections
...
class Resize:
    ...
    def __call__(self, imgmap):
        ...
        if isinstance(self.size, int):
            ...
            return [i.resize(self.size[::-1], self.interpolation) for i in imgmap]
...
class ToPILImage:
    def __call__(self, imgmap):
        totensor = transforms.ToPILImage()
        return [totensor(i) for i in imgmap]