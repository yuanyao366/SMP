...
def test_model(model,pretrain_path):
    ...
    test_dataset = ClassifyDataSet(params['dataset'], mode="test", split='1')
...
#     model=r21d.R2Plus1DNet((1,1,1,1),with_classifier=True, num_classes=101)
    ...
    pretrain_path = './outputs/ft_classify_SMP_c3d_UCF-101_UCF-101_split1/pt-05-02-18-54-e299-ft-05-05-15-30/best_loss_model_146.pth.tar'
